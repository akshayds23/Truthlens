-- PostgreSQL Schema for TruthLens AI
...
-- Evidence chunks table (with pgvector support)
...
COMMENT ON TABLE evidence_chunks IS 'Extracted and embedded text chunks from sources';

...
export default function LandingPage() {
  ...
  const handleExampleClick = (example: string) => {
    ...
    // Don't auto-submit so they can see it and click check, or we can auto-submit. Let's auto-submit.
  ...
  return (
    <div className="min-h-screen bg-gradient-mesh">
      ...
      {/* ── Footer ── */}
      <footer className="text-center py-8 text-xs text-gray-500 dark:text-gray-600 border-t border-gray-200 dark:border-gray-800/50">

 ...
 */
export const downloadMarkdown = (report: FactCheckReport & { claimText?: string }) => {
 ...
 */
export const downloadJSON = (report: FactCheckReport & { claimText?: string }) => {
 ...
 */
export const downloadPDF = async (report: FactCheckReport & { claimText?: string }) => {
  try {
